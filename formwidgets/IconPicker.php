...
class IconPicker extends FormWidgetBase
{
    ...
    /**
     * prepareVars prepares variables for the widget
     */
    ...
    /**
     * loadIcons loads FontAwesome icons from JSON file
     */
    ...
    {
        // Load FontAwesome for icon display
        // Use absolute path to avoid assetPath prepending issues
        $this->addCss('/plugins/blackfoxit/iconpicker/assets/css/all.min.css');
        
        // Widget assets - use relative paths from widget's asset directory
        // The assetPath is automatically set to formwidgets/iconpicker/assets/
